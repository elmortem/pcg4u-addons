...
public static class Task_20260723_033000
{
	public static async Task<string> Run()
	{
		...
		return $"generated={generated} restored={node.HeightOffset:F6} meshes={meshes} vertices={vertices} minY={minY:F6} maxY={maxY:F6} avgY={averageY:F6}";
	}
}
