...
public static class Task_20260722_380000
{
	...
	public static async Task<string> Run()
	{
		...
		report.Add(Render("D_SharpV", new[] { Corner(new float3(-40, 0, 18), new float3(-2, 0, -26), new float3(40, 0, 18)) }, 4f));
		report.Add(Render("D_Cross", new[]
		{
	...
	private static string Render(string label, Spline[] splines, float width)
	{
		...
		try
		{
			...
			cam.orthographicSize = Mathf.Max(ext * 0.42f, 4f);
