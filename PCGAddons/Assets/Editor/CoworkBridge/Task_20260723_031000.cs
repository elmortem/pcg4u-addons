...
public static class Task_20260723_031000
{
	public static async Task<string> Run()
	{
		...
		float original = node.HeightOffset;
		node.HeightOffset = original + 2f;
		...
		return $"generated={generated} original={original:F6} applied={node.HeightOffset:F6} meshes={meshes} vertices={vertices} minY={minY:F6} maxY={maxY:F6} avgY={averageY:F6}";
	}
}
