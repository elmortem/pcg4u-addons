...
public static class Task_20260722_340000
{
	...
	public static async Task<string> Run()
	{
		...
		report.Add(Render("M4_SharpV", new[] { Corner(new float3(-40, 0, 20), new float3(-2, 0, -30), new float3(40, 0, 20)) }, 8f));
		report.Add(Render("M4_Hairpin", new[] { Hairpin() }, 8f));
		report.Add(Render("M4_HairpinWide", new[] { HairpinWide() }, 8f));
		report.Add(Render("M4_Cross", new[]
		{
			Line(new float3(-30, 0, 0), new float3(30, 0, 0)),
			Line(new float3(0, 0, -30), new float3(0, 0, 30))
		}, 8f));
		report.Add(Render("M4_RoundedBend", new[] { Arc(40f, 5) }, 8f));
